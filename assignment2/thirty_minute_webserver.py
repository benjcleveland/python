...
defaults = ['block115384-uav.blueboxgrid.com', '8080']
...
def list_time(uri):
    return TIME_LISTING % datetime.datetime.now()
...
def get_content(uri):
    ...
    try:
        ...
        if os.path.isfile(path):
            if path.lower().endswith('.py'): # this is a python file, try to execute it
